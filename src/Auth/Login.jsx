...
//       if (!email || !password) {
//         console.warn("Please fille all  fields");
...
//       console.log("Login Email:", dataObject.email); // LOG ;

//       const documentId = await signInFirebase(dataObject, setError, setLoading);
//       if (!documentId) {
//         setError("enable to fetch user! try again later");
//         return;
//       } // user not found in database ;

//       // fetch use info from firestore and save it to local storage  for later use
    ...
    <Container maxWidth="lg" sx={{ display: "flex", justifyContent: "center" }}>
      <Paper
        ...
        sx={{
          ...
          padding: 4,
          borderRadius: 2,
          width: { md: 400, xs: "100%" }, // Fixed typo: sx → xs
          height: { md: 580, xs: "auto" },
          overflow: "auto",
          gap: 3,
        }}
      >
