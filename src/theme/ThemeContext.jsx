...
export default function ThemeContext({ children, modeChoice, setModeChoice, backgroundImg, setBackgroundImg, backgroundColor, setBackgroundColor }) {
    const isSystemDark = useMediaQuery("(prefers-color-scheme: dark)", {
        noSssr: true,
    });
    const effectiveMode = modeChoice === "browserTheme" ? (isSystemDark ? "dark" : "light") : modeChoice;
    ...
    const theme = useMemo(() => {
        ...
        const { primaryText, secondaryText } = isLight ? { primaryText: "#172B4D", secondaryText: "#5E6C84" } : { primaryText: "#EDF2FC", secondaryText: "#2a2c2e" };
            ...
            components: {
                ...
                MuiButton: {
                    styleOverrides: {
                        root: {
                            ...
                            "&:hover": {
                                backgroundColor: isLight ? alpha("#091E42", 0.08) : alpha("#fff", 0.1),
                            },
                        },
                        outlined: {
                            borderColor: isLight ? alpha("#091E42", 0.14) : alpha("#fff", 0.15),
                        },
                    },
                },
                MuiIconButton: {
                ...
                MuiPaper: {
                    styleOverrides: {
                        ...
                        elevation0: {
                            backgroundColor: isLight ? alpha("#fff", 0.5) : alpha("#1C2B41", 0.7),
                            border: `1px solid ${isLight ? "transparent" : alpha("#fff", 0.1)}`,
                        },
                        elevation1: {
                            boxShadow: isLight ? "0px 1px 2px 0px rgba(9, 30, 66, 0.25)" : "0px 1px 2px 0px rgba(0, 0, 0, 0.5)",
